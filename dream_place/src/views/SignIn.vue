      ...
      >
        ...
        >
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            <a
              href="/"
              class="flex items-center justify-center mb-6 text-2xl font-semibold"
            >
              Register
            </a>
            <form
            ...
            >
              <div>
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  class="sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-100 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500"
