<template>
    <div>
        <NavBar class="top-0 left-0 right-0 z-50 "/>
        <br>
            <br>

        <div class="bg-gray-100 pt-16  px-16">
...
<div class="min-w-screen min-h-screen flex items-center justify-center px-5 pb-10 pt-16">
  <div class="flex flex-col ">
  <div class="flex p-4 border border-white rounded-t-md dark:border-blue-600 dark:bg-blue-600">
    <svg xmlns="http://www.w3.org/2000/svg" class="secure" height="1em" viewBox="0 0 576 512"><path d="M512 80c8.8 0 16 7.2 16 16v32H48V96c0-8.8 7.2-16 16-16H512zm16 144V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V224H528zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm56 304c-13.3 0-24 10.7-24 24s10.7 24 24 24h48c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm128 0c-13.3 0-24 10.7-24 24s10.7 24 24 24H360c13.3 0 24-10.7 24-24s-10.7-24-24-24H248z"/></svg>
              <p class="text-white px-2 text-l">Payment options</p>
            </div>
    <div class="w-full mx-auto rounded-md bg-white shadow-lg p-5 text-gray-700" >
...
<div class="mb-3 -mx-2 flex items-end">
  <div class="px-2 w-1/2">
    ...
    <div>
      <select v-model="expirationMonth" class="form-select w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors cursor-pointer">
        <option value="April" >April</option>
        <!-- Options for expiration month -->
      </select>
    </div>
  </div>
  <div class="px-2 w-1/2">
    <select v-model="expirationYear" class="form-select w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors cursor-pointer">
      <!-- Options for expiration year -->
...
<div class="mb-3 -mx-2 flex items-end">
  ...
  <div class="flex p-4 border border-white bg-gray-50 rounded-t-md dark:border-yellow-500 dark:bg-yellow-500">
              <p class=" px-2 text-l">Important information about your booking</p>
              </div>
              <div class="p-8 rounded-md border-white bg-white">
              <p>1. This rate is non-refundable. If you change or cancel your booking you will not get a refund or credit to use for a future stay.</p>
              <p>2. Stay extensions will require a new reservation. </p>
              <p>3. Front desk staff will greet guests on arrival</p>
              <p>4. No refunds will be issued for late check-in or early check-out.</p>
      ...
      <div class="flex py-3 ">
        <svg xmlns="http://www.w3.org/2000/svg" class="lock" height="1em" viewBox="0 0 448 512"><path d="M144 144v48H304V144c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192V144C80 64.5 144.5 0 224 0s144 64.5 144 144v48h16c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V256c0-35.3 28.7-64 64-64H80z"/></svg>
          <p class="whitespace-nowrap px-2">We use secure transmission and encrypted storage to protect your personal information
</p>
        </div>
            </div>
            </div>
...
<div class="bg-white shadow rounded">
  ...
  <div class="p-4 flex flex-col ">
    ...
    <p class="text-gray-500  mt-1">Check in: Sunday, March 18, 2022</p>
    <p class=" text-gray-500 mt-1">Check out: Tuesday, March 20, 2022</p>
...
<!-- price details  -->
<div class="py-8 flex flex-col ">
            <div class="  flex p-4 rounded-t-md border border-white   dark:border-green-300 dark:bg-green-300">
              <p class=" px-2 text-l">Price Details</p>
            </div>
            <div class="w-full mx-auto rounded-md bg-white shadow-lg p-5 text-gray-500">
              ...
              <p>Tax and service fees</p>
                ...
                <div class="flex items-center justify-between py-2 font-semibold text-black">
              <p>Total</p>
                <p>$ 130</p>
                </div>
              </div>
