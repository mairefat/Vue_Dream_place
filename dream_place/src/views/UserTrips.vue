...
<div class="bg-gray-100">
    <h3 class="pt-32  pb-4 font-semibold text-2xl flex justify-center">My Trips</h3>
        <!-- my trips  -->
...
<div class="flex items-center">
  ...
  <div class="pt-4 flex flex-col">
   ...
   <div>
    ...
    <p class="text-sm text-gray-500 pb-4">Includes taxes and fees</p>
    <div class="">
        <button class="text-white bg-blue-600 rounded-md py-2  px-3 ">View trip details</button>
    </div>
   </div>
  </div>
</div>
