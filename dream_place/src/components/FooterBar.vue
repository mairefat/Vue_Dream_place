<template>
  <div >
    <div class="bottom-0 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        ...
        <router-link to="/" class="text-black" >my Dream Place</router-link>
          ...
          <div class="mt-4 lg:max-w-sm">
            <p class="text-gray-700 ml-6 font-sans text-base font-normal leading-normal tracking-tight" style="color: var(--Gray-2, #4F4F4F); font-family: SF Pro Display; font-size: 14px; font-style: normal; font-weight: 400; line-height: 140%; letter-spacing: 0.28px;">
                Your next goto companion for <br> travel
            </p>
          </div>
        </div>
