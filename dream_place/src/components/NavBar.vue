...
<template>
  <nav class="bg-white fixed p-4 w-full z-50">
    <div class="container mx-auto flex items-center justify-between">
      ...
      <div
        v-if="!isLoggedIn"
        class="hidden md:flex items-center space-x-4 bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded"
      >
        <router-link to="/signin" class="text-white">Login</router-link>
      </div>
      ...
      <div v-if="isLoggedIn" class="hidden xl:flex space-x-5 items-center">
        ...
        <div class="py-3 relative" @click="toggleDropdown">
          ...
          <div
            ...
            class="absolute top-full left-1/2 transform -translate-x-1/2 w-60 px-5 py-3 bg-gray-200 rounded-lg shadow border-transparent mt-3"
          >
            <ul class="space-y-3">
      ...
      <div
        ...
        class="md:hidden absolute top-16 left-0 right-0 bg-white"
      >
...
const isSearchResultRoute = () => {
  return route.name === "searchResult";
};

const logoColor = isSearchResultRoute() ? "white" : "#2F80ED";
